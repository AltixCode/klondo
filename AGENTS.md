...
`apps.json`). Fix it there and re-run `node scripts/bootstrap.mjs klondo`,
...
| | |
|---|---|
| Bundle id / package | `com.altixcode.klondo` |
| Scheme | `klondo://` |
| RevenueCat entitlement | `remove_ads` |
| RevenueCat package | `$rc_lifetime` |
| iOS product | `com.altixcode.klondo.removeads` |
| Android product | `remove_ads` |
| GitHub | `AltixCode/klondo` |
