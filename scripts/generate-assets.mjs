#!/usr/bin/env node
/**
 * Generates every brand asset for Klondo from one source of truth: the mark below.
 *
 ...
 */
const SHAPES = [{"type":"poly","points":[[0.5,0.07],[0.68,0.26],[0.83,0.42],[0.86,0.55],[0.79,0.66],[0.66,0.68],[0.56,0.62],[0.58,0.78],[0.66,0.92],[0.34,0.92],[0.42,0.78],[0.44,0.62],[0.34,0.68],[0.21,0.66],[0.14,0.55],[0.17,0.42],[0.32,0.26]],"fill":"accent"}];
 ...
 */
const MARK = [[1,1,1,0.12,0.12],[1,0.45,1,1,0.12],[1,1,0.45,1,1],[0.12,1,1,0.45,1],[0.12,0.12,1,1,1]];
...
console.log('Generating Klondo brand assets\n');
