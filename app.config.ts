...
/**
 * Store identity and native configuration for Klondo.
 *
...
const TRACKING_USAGE =
  'This lets us show you ads that are more relevant to you. Your data is never sold, and Klondo works exactly the same either way.';
...
const config: ExpoConfig = {
  ...
  assetBundlePatterns: ['**/*'],
  ios: {
    bundleIdentifier: 'com.altixcode.klondo',
    buildNumber: BUILD,
    supportsTablet: true,
